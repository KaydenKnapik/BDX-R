...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = BDX_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
    ...
    imu = ImuCfg(prim_path="{ENV_REGEX_NS}/Robot/IMU_Mount", debug_vis=True)  # change if needed
...
class RewardsCfg:
    ...
    #     },
    # )
    # joint_deviation_base = RewTerm(
    #     func=mdp.joint_deviation_l1,
    #     weight=-1.0,
    #     params={"asset_cfg": SceneEntityCfg("robot", joint_names=["base_joint"])},
    # )
...
class TerminationsCfg:
    ...
    # base_height = DoneTerm(func=mdp.root_height_below_minimum, params={"minimum_height": 0.05})
